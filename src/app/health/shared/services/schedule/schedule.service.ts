...
import { ScheduleList } from '../../interfaces/schedule-list.interface';
...
export class ScheduleService {
  ...
  private getSchedule(startAt: number, endAt: number): FirebaseListObservable<any[]> {
